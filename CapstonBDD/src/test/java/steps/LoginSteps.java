...
public class LoginSteps {
	...
	public void user_has_opened_application() {
		...
		System.setProperty("webdriver.chrome.driver", "C:\\installbles\\chromedriver_win32\\chromedriver.exe");
//	     WebDriver driver;
...
//		driver.findElement(By.name("email_id")).sendKeys("shireesha@domain.com");
//		driver.findElement(By.name("pwd")).sendKeys("shireesha");
//		driver.findElement(By.name("pwd2")).sendKeys("shireesha");
//		driver.findElement(By.name("name")).sendKeys("shireesha");
